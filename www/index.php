...
<body>
    ...
    <div class="row py-2 px-lg-5">
      <div class="col-lg-6 text-center text-lg-left mb-2 mb-lg-0">
        <div class="d-inline-flex align-items-center text-white">
          ...
          <small><i class="fa fa-envelope mr-2"></i>admin@iesharia.com</small>
        </div>
      </div>
  ...
  <div class="container-fluid p-0">
    <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 px-lg-5">
      <a href="index.html" class="navbar-brand ml-lg-3">
        <h1 class="m-0 text-uppercase text-primary"><i class="fa fa-book-reader mr-3"></i>IES Haría</h1>
      </a>
  ...
  <div class="jumbotron jumbotron-fluid position-relative overlay-bottom" style="margin-bottom: 90px;">
    <div class="container text-center my-5 py-5">
      <h1 class="text-white mt-4 mb-4">Ven a estudiar con nosotros !!</h1>
      <h1 class="text-white display-1 mb-5">IES Haría</h1>
    ...
    <div class="container py-5">
      <div class="row">
        ...
        <div class="col-lg-7">
          ...
          <p>"¡Bienvenidos al IES Haría en el pintoresco municipio de Haría, Lanzarote! Nuestra institución se enorgullece de ofrecer una educación de calidad en un entorno natural único. Situado en el corazón de esta encantadora localidad, nuestro instituto es un lugar donde la tradición se une con la innovación para brindar a nuestros estudiantes una experiencia educativa enriquecedora."</p>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-7 my-5 pt-5 pb-lg-5">
          ...
          <p class="mb-4 pb-2">En el IES Haría, nos esforzamos por cultivar el conocimiento, la creatividad y el respeto, preparando a nuestros jóvenes para enfrentar los desafíos del mundo actual. Únete a nuestra comunidad escolar y descubre todo lo que tenemos para ofrecer en este rincón especial de Lanzarote."</p>
      ...
      <div class="row">
        <div class="col-md-6 mb-5">
          <a href="index.php" class="navbar-brand">
            <h1 class="mt-n2 text-uppercase text-white"><i class="fa fa-book-reader mr-3"></i>IES Haría</h1>
          </a>
